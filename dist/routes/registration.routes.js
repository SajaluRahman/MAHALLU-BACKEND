...
router.get('/families/:mahalluCode', registration_controller_1.getFamiliesForRegistration);
// Protected admin routes
router.use(auth_1.authenticate);
router.use((0, auth_1.authorizeRoles)(shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.SECRETARY));
