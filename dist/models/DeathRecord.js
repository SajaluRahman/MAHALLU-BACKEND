...
exports.DeathRecord = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const DeathRecordSchema = new mongoose_1.Schema({
    ...
    cemeteryId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Cemetery' }, plotId: String,
    expenses: [{ description: String, amount: Number, paidById: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Member' } }],
    certificateId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Certificate' },
}, { timestamps: true });
DeathRecordSchema.index({ tenantId: 1, memberId: 1 });
exports.DeathRecord = mongoose_1.default.model('DeathRecord', DeathRecordSchema);
//# sourceMappingURL=DeathRecord.js.map